...
class CollegeClassControllerTest {
    ...
    private val aClassCode = ClassCode("c1", "a1", "h1", "c1", "s1")
    private val anotherClassCode = ClassCode("c2", "a2", "h2", "c2", "s2")
    ...
    @Test
    fun returnsEmptyMapWhenClassIsNotCached() {
        val expected = HashMap<String, CollegeClass?>()

        val actual = controller.getCollegeClasses(123)
